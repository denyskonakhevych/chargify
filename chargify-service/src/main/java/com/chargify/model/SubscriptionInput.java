...
{
  public SubscriptionInput( String id, String productHandle )
  {
    this.id = id;
  ...
  public void addComponent( ProductComponentItem component )
  {
    if( components == null )
      components = new ArrayList<ProductComponentItem>();
